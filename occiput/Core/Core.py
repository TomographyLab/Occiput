...
from ..Visualization import DisplayNode, VolumeRenderer, has_ipy_table, TriplanarView
from ..Visualization.Visualization import MultipleVolumes, MultipleVolumesNiftyPy, ipy_table
...
from .Conversion import occiput_to_nifti
...
class ImageND(object):
    ...
    def display(self, clim=None, cmap=None, figsize=(20, 9)):
...
class Image3D(ImageND):
    ...
    def _display_in_browser(self, axis=0):
        D = self.display(axis)
