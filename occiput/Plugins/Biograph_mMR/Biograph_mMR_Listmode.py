from ...Functional.SimpleWrap import find_c_library, load_c_library, localpath, call_c_function, filepath
from ...DataSources.PetLink import petlink
import numpy as np
...
def get_gates(): 
     ...
     descriptor = [  {'name':'N',                     'type':'uint',      'value':N              }, 
                     {'name':'type',                  'type':'array',     'value':None,   'dtype':np.int32,  'size':(N),       'order':'F'},
                     {'name':'time',                  'type':'array',     'value':None,   'dtype':np.int32,  'size':(N),       'order':'F'},
                     {'name':'payload',               'type':'array',     'value':None,   'dtype':np.int32,  'size':(N),       'order':'F'}  ]
...
def get_static_projection_info_prompt(time_bin): 
    ...
    descriptor = [  {'name':'time_bin',                'type':'uint',      'value':time_bin       }, 
                    ...
                    {'name':'angles_axial',            'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,10000) },
                    {'name':'angles_azimuthal',        'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,10000) },
...
def get_global_static_projection_info_prompt(): 
    ...
    descriptor = [  {'name':'time_start',              'type':'uint',      'value':None           }, 
                    ...
                    {'name':'N_axial',                 'type':'uint',      'value':None           }, 
                    {'name':'N_azimuthal',             'type':'uint',      'value':None           }, 
                    {'name':'angles_axial',            'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,10000), 'order':'F' },
                    {'name':'angles_azimuthal',        'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,10000), 'order':'F' },
                    {'name':'size_u',                  'type':'float',     'value':None           }, 
                    {'name':'size_v',                  'type':'float',     'value':None           }, 
                    {'name':'N_u',                     'type':'uint',      'value':None           }, 
                    {'name':'N_v',                     'type':'uint',      'value':None           },  ] 
...
def get_static_projection_prompt(time_bin): 
     ...
     descriptor = [  {'name':'time_bin',                'type':'uint',      'value':time_bin       }, 
                     ...
                     {'name':'N_u',                     'type':'uint',      'value':None           }, 
                     {'name':'N_v',                     'type':'uint',      'value':None           },  
                     {'name':'offsets',                 'type':'array',     'value':None,   'dtype':np.int32,  'size':(N_azimuthal,N_axial), 'order':'F'},
                     {'name':'counts',                  'type':'array',     'value':None,   'dtype':np.float32,  'size':(N_locations),       'order':'F'},
                     {'name':'locations',               'type':'array',     'value':None,   'dtype':np.uint16,  'size':(3,N_locations),      'order':'F'},             ]
...
def get_global_static_projection_prompt(): 
    ...
    descriptor = [  {'name':'time_start',              'type':'uint',      'value':None           }, 
                    ...
                    {'name':'N_axial',                 'type':'uint',      'value':None           }, 
                    {'name':'N_azimuthal',             'type':'uint',      'value':None           }, 
                    {'name':'angles_axial',            'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,N_axial) },
                    {'name':'angles_azimuthal',        'type':'float',     'value':None,    'dtype':np.float32,   'size':(1,N_azimuthal) },
                    {'name':'size_u',                  'type':'float',     'value':None           }, 
                    {'name':'size_v',                  'type':'float',     'value':None           }, 
                    {'name':'N_u',                     'type':'uint',      'value':None           }, 
                    {'name':'N_v',                     'type':'uint',      'value':None           },  
