...
def get_data(n_samples_breathing, n_samples_ecg_I, n_samples_ecg_aVF, n_samples_pulse_ox, n_samples_external): 
    ...
    descriptor = [  {'name':'n_samples_breathing', 'type':'uint',     'value':n_samples_breathing      }, 
                    ...
                    {'name':'samples_breathing', 'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_breathing)},
                    {'name':'samples_ecg_I',     'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_ecg_I)},
                    {'name':'samples_ecg_aVF',   'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_ecg_aVF)},
                    {'name':'samples_pulse_ox',  'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_pulse_ox)},
                    {'name':'samples_external',  'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_external)},
                    {'name':'triggers_breathing','type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_breathing)},
                    {'name':'triggers_ecg_I',    'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_ecg_I)},
                    {'name':'triggers_ecg_aVF',  'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_ecg_aVF)},
                    {'name':'triggers_pulse_ox', 'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_pulse_ox)},
                    {'name':'triggers_external', 'type':'array',  'value':None, 'dtype':np.uint16, 'size':(n_samples_external)},
                 ]
